...
include_once'connect.php';
    ...
    if(isset($_POST['update'])){
        ...
        $query = " UPDATE fish SET fishId = $fishId, fishName = '$fishName' , fishSize = '$fishSize' , fishWight = '$fishWeight',noOfFish ='$noOfFish',farmId=$farmId
        WHERE fishId = $fishId  ";
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">update fish</div>
