...
include_once'connect.php';
    ...
    if(isset($_POST['insert'])){
        ...
        $query = " INSERT INTO sale( saleAmount , farmId) VALUES('$saleAmount','$farmId')  ";
                                        ...
                                        <form action="" method="POST" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="saleName" name="saleAmount" placeholder="sale Amount" class="form-control">
                                                </div>
                                            </div>
                                           <!-- <div class="form-group">
                                                <div class="input-group">
